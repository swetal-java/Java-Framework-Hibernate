			...
			<div class="col-md-7 col-lg-5 px-lg-2 col-xl-4 px-xl-0 px-xxl-3">
				<form class="w-100 rounded-1 p-4 border bg-white"
					...
					<label class="d-block mb-4"> <span
						class="form-label d-block"></span> <input name="otp2"
						type="text" class="form-control" placeholder="Enter OTP.." />
					</label>

					<div class="mb-3">
						<button name="action" value="verifyotp"
							class="btn btn-primary px-3 rounded-3">Verify OTP</button>
